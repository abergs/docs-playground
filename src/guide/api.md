...
|`displayname`|A human-palatable name for the account, which should be chosen by the user.|`Phillip J Fry`|
...
Use the `.success` value (`true` or `false`) to determine next actions, i.e. whether to complete the sign-in.
